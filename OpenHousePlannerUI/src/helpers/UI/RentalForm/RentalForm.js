  ...
  return (
    ...
    <Form>
      ...
      <FormGroup>
        ...
        <Input type="input" name="street" id="state" onChange={this.onRentalChange} defaultValue={rentalInfo.state} placeholder="with a placeholder" />
      </FormGroup>
      <FormGroup>
      ...
      <FormGroup check>
        <Label check>
          <Input type="checkbox" name="hasTenant" id="hasTenant" placeholder="with a placeholder" onChange={this.onRentalChange} defaultValue={rentalInfo.sqft} />
          Has Tenant
        </Label>
      </FormGroup>
